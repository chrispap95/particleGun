                ...
                for phi in phis:
                    for delta in deltas:
                        ...
                        if options.closeBy:
                            ...
                            file0 = open("{}{}_cfi.py".format(GEN_DIR, outTag), "w")
                            file0.write(
                            ...
                            file0 = open("{}{}_pythia8_cfi.py".format(GEN_DIR, outTag), "w")
                            file0.write(
                                "# Generator fragment automatically generated by submit.py\n\n"
                            )
                            file0.write("import FWCore.ParameterSet.Config as cms\n\n")
                        ...
                        os.chdir("{}/myGeneration/{}".format(CWD, outTag))
                        pythiaTag = "_pythia8"
                        if options.closeBy:
                            pythiaTag = ""
                        proc = ""
                        ...
                        filein = None
                        script = "{}{}_cfi_py_GEN_SIM.py".format(outTag, pythiaTag)
                        writeCRABConfig(
                            options,
                            outTag,
                            nThreads,
