...
def mainParser():
    parser = argparse.ArgumentParser(description='Submit and manage multiple particle gun jobs with CRAB3.',usage='%(prog)s [options]')
    ...
    parser.add_argument('--maxEn', help='Maximum of energy range in case of continuous energy distribution. (Default is 650 GeV)',default=None)
    parser.add_argument('--minEn', help='Minimum of energy range in case of continuous energy distribution. (Default is 0 GeV)',default=None)
    parser.add_argument('--maxEta', help='Maximum of eta range in case of continuous eta distribution. (Default is 3.0)',default=None)
